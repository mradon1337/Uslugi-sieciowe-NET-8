...
// Serilog - czyta konfiguracje z appsettings.json
builder.Host.UseSerilog((context, config) =>
    config.ReadFrom.Configuration(context.Configuration));

// kontrolery (do obslugi bledow)
...
// globalna obsluga bledow - na samej gorze potoku
...
// wszystkie miasta
app.MapGet("/miasta", (ILogger<Program> logger) =>
{
    logger.LogInformation("Pobrano liste miast");
    return miasta;
});
